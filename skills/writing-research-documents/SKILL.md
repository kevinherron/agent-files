...
description: "Create or update an evidence-backed Markdown research document. Use when findings should become a durable artifact, not for conversational answers or implementation."
---
...
Use available tool orchestration for independent reads and deterministic reduction.
Keep adaptive retrieval dependent on inspected results; verify citations and conclusions
